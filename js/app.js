(() => {
    ...
    (() => {
        ...
        var barba_umd = __webpack_require__(69);
        function isWebp() {
        ...
        function funcInputRange() {
            ...
            const timing = [ 0, 3, 5, 7.24, 9.24, 12.22, 14.22, 16.22, 18.22, 20.22, 22.22, 24.22, 26.22, 28.22, 30.22, 32.22, 34.22, 36.22, 38.22, 42.1, 44.1, 46.1, 49, 51, 53, 55, 57 ];
            let inputWidth;
            let sliceInputWidth;
            let width;
                ...
                input.oninput = function() {
                    ...
                    timing.forEach(((time, id) => {
                        if (video.currentTime >= time) {
                            ...
                            idTiming = id;
                        } else if (video.currentTime < time) dots[id].style.backgroundColor = "white";
                    }));
                };
                input.addEventListener("change", (() => {
                    ...
                    if (idTiming >= 15) {
                        if (null != btnTabTwo) {
                            ...
                            var tb1 = anime_es.timeline({
                                easing: "easeOutExpo",
                                duration: 300
                            });
                            var tb2 = anime_es.timeline({
                                easing: "easeOutExpo",
                                duration: 300
                            });
                            tb2.add({
                    ...
                    } else if (idTiming < 15) if (null != btnTabOne) {
                        tabContentOne.style.display = "flex";
                        tabContentTwo.style.display = "none";
                        tb1 = anime_es.timeline({
                            easing: "easeOutExpo",
                            duration: 300
                        });
                        tb2 = anime_es.timeline({
                            easing: "easeOutExpo",
                            duration: 300
                        });
                        tb1.add({
        ...
        function changeIcon(idTiming) {
            ...
            const numbersIconForPeriods = [ [ 1, 8 ], [ 1, 4, 3 ], [ 1, 4, 3 ], [ 1, 4, 3 ], [ 1, 3 ], [ 1, 7, 5 ], [ 1 ], [ 1 ], [ 1 ], [ 1 ], [ 1 ], [ 1 ], [ 1, 4, 3 ], [ 1, 4, 3, 5 ], [ 1, 4, 3 ], [ 1, 7, 3, 4 ], [ 1, 3, 4, 6 ], [ 1, 2, 3, 7 ], [ 1, 2, 3, 6 ], [ 1, 2, 3, 7 ], [ 1, 6, 7 ], [ 1, 2, 3, 7, 6 ], [ 1, 4, 7, 2, 3 ], [ 1, 2, 3, 7, 4, 6 ], [ 1, 2, 3, 7 ], [ 1, 7, 3 ], [ 1, 3 ] ];
            const linksForPeriods = [ "Катархей", "Эоархей", "Палеоархей", "Мезоархей", "неоархей", "сидерий", "Рясий", "Орозий", "Статерий", "Калимий", "Эктазий", "стений", "Тоний", "криогений", "эдиакарий", "кембрий", "Ордовик", "силур", "девон", "карбон", "пермь", "триас", "Юра", "мел", "палеоген", "Неоген", "Четвертичный" ];
            ...
            nmb.forEach(((item, id) => {
                if (void 0 != nmb[id]) {
                    flag = id;
                    if (0 == flag) iconContainer[1].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`; else if (1 == flag) iconContainer[4].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`; else if (2 == flag) iconContainer[0].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`; else if (3 == flag) iconContainer[2].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`; else if (4 == flag) iconContainer[3].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`; else if (5 == flag) iconContainer[5].innerHTML = `<a href="${linksForPeriods[idTiming]}.html"><img src="img/icons/nav-${nmb[id]}.svg" alt="icon"></a>`;
                }
            }));
        }
        ...
        function animationToggleNavMenu() {
            if (1 == sessionStorage.getItem("toggle-nav")) {
                var tl = anime_es.timeline({
                    easing: "easeOutExpo",
                    duration: 500
                });
                tl.add({
            ...
            } else if (2 == sessionStorage.getItem("toggle-nav")) {
                let tl = anime_es.timeline({
                    easing: "easeOutExpo",
                    duration: 200
                });
                tl.add({
        ...
        function pageAnimIn() {
            var tt = anime_es.timeline({
                easing: "easeOutExpo",
                duration: 900
            });
            var tte = anime_es.timeline({
                easing: "easeOutExpo",
                duration: 900
            });
            tt.add({
        ...
        function toggleTabs() {
            ...
            const tabContentOne = document.querySelector("#tab_1");
            const tabContentTwo = document.querySelector("#tab_2");
            if (null != btnTabOne) btnTabOne.addEventListener("click", (() => {
                tabContentOne.style.display = "flex";
                tabContentTwo.style.display = "none";
                var tb1 = anime_es.timeline({
                    easing: "easeOutExpo",
            ...
            if (null != btnTabTwo) btnTabTwo.addEventListener("click", (() => {
                tabContentTwo.style.display = "flex";
                tabContentOne.style.display = "none";
                var tb1 = anime_es.timeline({
                    easing: "easeOutExpo",
        ...
        function togglePeriods() {
            ...
            btnDrop.forEach(((item, id) => {
                item.addEventListener("click", (() => {
                    let showArrowContentAnimation = anime_es.timeline({
                        easing: "easeOutExpo",
                        duration: 300
                    });
                    if (1 == window.getComputedStyle(contentDrop[id]).opacity) {
                        contentDrop[id].id;
                        console.log(contentDrop[id]);
                        showArrowContentAnimation.add({
                            targets: btnDrop[id],
                            rotate: -90,
                            duration: 200
                        }).add({
                    ...
                    } else if (0 == window.getComputedStyle(contentDrop[id]).opacity) {
                        contentDrop[id].id;
                        showArrowContentAnimation.add({
                            targets: btnDrop[id],
                            rotate: 0,
